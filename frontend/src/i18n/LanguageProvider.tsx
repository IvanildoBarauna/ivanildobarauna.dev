...
const dictionaries: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'Projeto e construo sistemas que conectam Engenharia de Software, Dados e Arquitetura para transformar problemas complexos de negócio em decisões automatizadas e soluções prontas para produção — da ingestão à ação.': 'I design and build systems that connect Software Engineering, Data, and Architecture to turn complex business problems into automated decisions and production-ready solutions — from ingestion to action.',
    ...
    'Resolução de problemas de ponta a ponta': 'End-to-end problem solving', 'Software gera dados. Dados alimentam analytics, decisões e impacto.': 'Software generates data. Data drives analytics, decisions, and impact.',
    ...
    'Construo produtos de software do zero em Advanced Analytics & Machine Learning. Entreguei um sistema de decisão para disputas, desenvolvo uma plataforma tributária full-stack e apoio decisões de arquitetura.': 'I build software products from scratch in Advanced Analytics & Machine Learning. I delivered a dispute decision system, develop a full-stack tax platform, and support architecture decisions.',
    'Transformei análises em decisões automatizadas com microsserviços, rule engines, APIs e pipelines transacionais em BigQuery e GCP, apoiando auditoria e detecção de incidentes em escala LATAM.': 'I turned analytics into automated decisions using microservices, rule engines, APIs, and transactional pipelines on BigQuery and GCP, supporting auditing and incident detection at LATAM scale.',
  ...
  es: {
    ...
    'Sobre mim': 'Sobre mí', 'Projetos': 'Proyectos', 'Experiência': 'Experiencia', 'Formação': 'Formación', 'Senior Software Engineer @ Mercado Livre': 'Ingeniero de Software Sénior en Mercado Livre', 'Senior Software Engineer': 'Ingeniero de Software Sénior', 'Senior Data Engineer': 'Ingeniero de Datos Sénior',
    ...
    'Projeto e construo sistemas que conectam Engenharia de Software, Dados e Arquitetura para transformar problemas complexos de negócio em decisões automatizadas e soluções prontas para produção — da ingestão à ação.': 'Diseño y construyo sistemas que conectan Ingeniería de Software, Datos y Arquitectura para transformar problemas complejos de negocio en decisiones automatizadas y soluciones listas para producción, desde la ingesta hasta la acción.',
    ...
    'Construo produtos de software do zero em Advanced Analytics & Machine Learning. Entreguei um sistema de decisão para disputas, desenvolvo uma plataforma tributária full-stack e apoio decisões de arquitetura.': 'Construyo productos de software desde cero en Advanced Analytics & Machine Learning. Entregué un sistema de decisión para disputas, desarrollo una plataforma tributaria full-stack y apoyo decisiones de arquitectura.',
    'Transformei análises em decisões automatizadas com microsserviços, rule engines, APIs e pipelines transacionais em BigQuery e GCP, apoiando auditoria e detecção de incidentes em escala LATAM.': 'Transformé análisis en decisiones automatizadas mediante microservicios, motores de reglas, APIs y pipelines transaccionales en BigQuery y GCP, apoyando auditoría y detección de incidentes a escala LATAM.',
