...
const dictionaries: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'Sobre mim': 'About me', 'Projetos': 'Projects', 'Experiência': 'Experience', 'Formação': 'Education',
    ...
    'Solução em destaque': 'Featured solution', 'Uma solução end-to-end que transforma dados recebidos por requisições de API em informações prontas para análise: a Producer API publica eventos no Pub/Sub; o pipeline assíncrono os processa no Dataflow e os armazena no BigQuery.': 'An end-to-end solution that turns data received through API requests into analysis-ready information: the Producer API publishes events to Pub/Sub; the asynchronous pipeline processes them in Dataflow and stores them in BigQuery.',
